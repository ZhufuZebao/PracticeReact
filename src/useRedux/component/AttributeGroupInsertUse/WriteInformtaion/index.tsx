    ...
    <div>
      ...
      <div className={classes.line}>
        ...
        <FormControl variant="outlined" className={classes.formControl}>
          <Select
            data-testid={'attributeGroupType'}
            native
          ...
          >
            ...
            <option value={'DTing'}>DTing</option>
      ...
      <div className={classes.line}>
        ...
        <Grid item >
          <AntSwitch data-testid={'showType'} checked={insertAttributeGroupDate.showType} onClick={() => {changeNewDate(!insertAttributeGroupDate.showType,'showType')}} name="checkedC"/>
        </Grid>
      </div>
      <div className={classes.intervalDiv}/>
      <div className={classes.line}>
